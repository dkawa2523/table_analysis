...
_COMMON_PIPELINE_UI_FIELDS = (
    ...
    PipelineUiField("pipeline.run_dataset_register"),
    PipelineUiField("pipeline.run_preprocess"),
    PipelineUiField("pipeline.run_train"),
    PipelineUiField("pipeline.run_train_ensemble"),
    PipelineUiField("pipeline.run_leaderboard"),
    PipelineUiField("pipeline.run_infer"),
    PipelineUiField("pipeline.plan_only"),
