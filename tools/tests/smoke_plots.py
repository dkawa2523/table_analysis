#!/usr/bin/env python3
"""Local-mode smoke test for lightweight plots."""
...
def main() -> int:
    ...
    smoke_root = repo / "work" / "_smoke_plots"
    tmp = smoke_root / "tmp"
    ...
    pngs = sorted(tr_dir.glob("*.png"))
    if not pngs:
        raise AssertionError("Expected at least one plot PNG under 03_train_model")
